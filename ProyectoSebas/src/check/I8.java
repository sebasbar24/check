 ...
 * @author USER
 */
public class I8 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(check, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 90, 130, 35));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(I8.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
