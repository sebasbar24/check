 ...
 * @author USER
 */
public class I9 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(check, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 90, 118, 43));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(I9.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
